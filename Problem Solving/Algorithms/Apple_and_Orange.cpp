...
void countApplesAndOranges(int left, int right, int a, int b, vector<int> apples, vector<int> oranges) {
    ...
    {
        if(apples[i] > 0) // Possible iff apple land to the right
        {
            position = a + apples[i];
    ...
    {
        if(oranges[i] < 0) // Possible iff oranges land to the left
        {
